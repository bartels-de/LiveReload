...
namespace LiveReload
{
    public class LiveReloadMiddleware
    {
        ...
        /// </summary>
        internal static ConcurrentDictionary<WebSocket, byte> ActiveSockets { get; } = new();
        ...
        private async Task HandleHtmlInjection(HttpContext context)
        {
            ...
            await using var filteredResponse = new ResponseStreamWrapper(context.Response.Body, context);
        ...
        private async Task WebSocketWaitLoop(WebSocket webSocket)
        {
            ...
            ActiveSockets.TryRemove(webSocket, out var throwAway);
